...
Only the latest released version of this role receives security fixes.
...
Instead, report them privately via [GitHub private vulnerability reporting](https://github.com/iamenr0s/ansible-role-users/security/advisories/new).
